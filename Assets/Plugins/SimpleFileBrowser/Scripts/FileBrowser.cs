...
namespace SimpleFileBrowser
{
	public class FileBrowser : MonoBehaviour, IListViewAdapter
	{
		...
		public static bool overrideLoadPath = false;
		public static string loadPath = "";

		public static void SetLoadPath(string s) {
			overrideLoadPath = true;
			loadPath = s;
...
#pragma warning restore 0649
		...
		public static bool ShowHiddenFiles
		{
			...
			set { Instance.showHiddenFilesToggle.SetIsOnWithoutNotify(value); }
		}
...
#pragma warning restore 0414
		...
		[SerializeField]
		private TextMeshProUGUI filenameInputFieldOverlayText;
...
#pragma warning restore 0414
		...
		private void Awake()
		{
			transform.SetParent(GameObject.Find("Canvas-HERE").transform);
